        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 flex text-center items-center">
            ...
            <div className="flex-1 h-full flex flex-col justify-center border-r border-b md:border-b-0 border-neutral-700">
              <div className="py-4">
                <div className="text-neutral-500 text-sm font-semibold mb-0.5">Current Price</div>
            ...
            <div className="flex-1 h-full flex flex-col justify-center md:border-r border-b md:border-b-0 border-neutral-700">
              <div className="py-4">
                <div className="text-neutral-500 text-sm font-semibold mb-0.5">Volume</div>
          ...
          <div className="flex-1 flex text-center items-center">
            ...
            <div className="flex-1 h-full flex flex-col justify-center border-r border-neutral-700">
              <div className="py-4">
                <div className="text-neutral-500 text-sm font-semibold mb-0.5">Lorem Ipsum 3</div>
                <div className="text-2xl">123456</div>
              </div>
            </div>
            {/* Second Item */}
            <div className="flex-1 h-full flex flex-col justify-center">
              <div className="py-4">
                <div className="text-neutral-500 text-sm font-semibold mb-0.5">Lorem Ipsum 4</div>
                <div className="text-2xl">123456</div>
              </div>
            </div>
          </div>
