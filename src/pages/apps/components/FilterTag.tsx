...
const FilterTag = (props: Props) => {
  return (
    <button
      ...
      className={
        "inline-block text-sm px-1.5 py-0.5 rounded-md overflow-hidden transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-cyan-500 dark:focus-visible:ring-cyan-500" +
