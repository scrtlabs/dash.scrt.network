...
import { WrapContext } from 'pages/wrap/Wrap'
...
const UnknownBalanceModal = (props: any) => {
  ...
  const { amount: amountToWrap, hasEnoughBalanceForUnwrapping, selectedToken } = useContext(WrapContext)
            ...
            >
              ...
              <div className="mb-4 text-center">
                ...
                <p className="text-neutral-400 max-w-sm mx-auto mb-6">
                  You're trying to unwrap {amountToWrap} s{selectedToken.name} without having a Viewing Key set. Make
                  sure you definitely have {amountToWrap} s{selectedToken.name} in this wallet, otherwise this action
                  will fail!
