...
export const batchQueryContractAddress =
  "secret17gnlxnwux0szd7qhl90ym8lw22qvedjz4v09dm";
export const batchQueryCodeHash =
  "72a09535b77b76862f7b568baf1ddbe158a2e4bbd0f0879c69ada9b398e31c1f";

export const restakeThreshold = 10_000_000;

export const keplrChainRegistryUrl =
  ...
  return new Promise((resolve, reject) => {
    const intervalId = setInterval(async () => {
      ...
      if (++retries > maxRetries) {
        ...
        reject(
          new Error(
            `Transaction not found after ${maxRetries * (intervalMs / 1000)} seconds`,
          ),
        );
      }
    }, intervalMs);
...
export const toCurrencyString = (
  ...
  const fractionDigits =
    number !== null && number !== undefined ? getFractionDigits(number) : 0;
  return new Intl.NumberFormat(undefined, {
    style: "currency",
    currency: currency,
    ...fractionDigits,
...
export const debugModeOverride: boolean =
