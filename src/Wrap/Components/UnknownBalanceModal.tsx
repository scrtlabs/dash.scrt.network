import { faCheckCircle, faCircleCheck, faDesktop, faMobileScreen, faShuffle, faTriangleExclamation, faXmark } from "@fortawesome/free-solid-svg-icons";
...
const UnknownBalanceModal = (props) => {
  ...
  const {selectedTokenName, amount: amountToWrap, hasEnoughBalanceForUnwrapping } = useContext(WrapContext);
            ...
            <div className="bg-neutral-900 p-8 rounded-2xl" onClick={(e) => {e.stopPropagation()}}>
              ...
              <div className="mb-4 text-center">
                ...
                <p className="text-neutral-400 max-w-sm mx-auto mb-6">
                  You're trying to unwrap {amountToWrap} s{selectedTokenName} without having a Viewing Key set. Make sure you definitely have {amountToWrap} s{selectedTokenName} in this wallet, otherwise this action will fail!
                ...
                <If condition={!hasEnoughBalanceForUnwrapping}>
                  <>
                    <p className="text-neutral-400 max-w-sm mx-auto mb-6">
                      You do not have enough SCRT to unwrap. A Fee Grant has been requested... 
                    </p>
                    <div className="text-neutral-400 max-w-sm mx-auto mb-6">
                      <FontAwesomeIcon icon={faCheckCircle} className="mr-2 text-green-500"/>Fee Granted
                    </div>
                  </>
                </If>
