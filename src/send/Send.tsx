...
import { getWalletViewingKey } from 'shared/context/SecretjsContext'
...
export function Send() {
  ...
  async function setBalance() {
    try {
      ...
      // setLoadingTokenBalance(true) // TODO: CHECK
      await updateCoinBalance()
      await updateTokenBalance()
    } finally {
      setLoadingCoinBalance(false)
      // setLoadingTokenBalance(false) // TODO: CHECK
    }
  }
  ...
  function NativeTokenBalanceUi() {
    if (!loadingCoinBalance && isConnected && nativeBalance) {
      return (
        <>
  ...
  function WrappedTokenBalanceUi() {
    if (isTokenBalanceLoading || !isConnected || !tokenBalance) {
      return <></>
      ...
      <>
        <div className="flex flex-col gap-4 items-center">
          <button
            ...
            onClick={() => submit()}
          >
            {walletAddress && secretNetworkClient && amount ? (
              <>{`Send ${amount} ${
  ...
  }, [walletAddress, secretNetworkClient, selectedToken, feeGrantStatus])
  ...
  return (
    <>
      ...
      <div className="w-full max-w-xl mx-auto px-4 onEnter_fadeInDown relative">
        {!secretNetworkClient && !walletAddress ? (
        ...
        <div className="border border-neutral-200 dark:border-neutral-700 rounded-2xl p-8 w-full text-neutral-800 dark:text-neutral-200 bg-white dark:bg-neutral-900">
          ...
          <div className="bg-neutral-200 dark:bg-neutral-800 p-4 rounded-xl mb-4">
            ...
            <div className="flex mt-2" id="destinationInputWrapper">
              <Select
                isDisabled={!selectedToken.address || !walletAddress}
          ...
          <SubmitButton
            disabled={
              !secretNetworkClient || !selectedToken.address || !walletAddress
            }
            amount={amountString}
