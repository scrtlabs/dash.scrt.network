import { faArrowTrendUp, faAward, faCircle, faCube } from "@fortawesome/free-solid-svg-icons";
      ...
      {props.amount && (
        <div className="col-span-12 sm:col-span-6  xl:col-span-3 bg-neutral-800 p-4 rounded-lg">
          <div className="flex flex-col items-center">
            ...
            <div className="font-semibold text-lg">{props.amount ? props.amount.toLocaleString() : ""} SCRT</div>
