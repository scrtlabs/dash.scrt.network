...
const ThemeContextProvider = ({children}) => {
  ...
  useEffect(() => {
    ...
    let userPrefersDarkTheme: boolean = window.matchMedia('(prefers-color-scheme: dark)').matches;
    let userPrefersLightTheme: boolean = window.matchMedia('(prefers-color-scheme: light)').matches;
