  ...
  return (
    <>
      <ul className="space-y-4 font-bold text-neutral-400">
        ...
        <li>
        <NavLink to="/" className={({ isActive }) => isActive ? "text-white bg-gradient-to-r from-zinc-700 via-zinc-700-700 to-zinc-700/5 block w-full px-8 py-5 rounded-full transition-colors" : "hover:text-white block w-full px-8 py-5 rounded-full transition-colors flex items-center"}>
