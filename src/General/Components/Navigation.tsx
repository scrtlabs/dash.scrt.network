import { faArrowUpRightFromSquare, faBox, faChartLine, faCheckToSlot, faChevronDown, faCircleNodes, faClose, faCoins, faCube, faEllipsis, faShuffle } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
      ...
      <div className='mt-12'>
        ...
        <button onClick={() => toggleIsExtendedMenuOpen()}
          ...
          <FontAwesomeIcon icon={faChevronDown} className={'flex-initial ml-4' + (isExtendedMenuOpen ? ' fa-rotate-180' : '')}/>
        </button>

        <div className={isExtendedMenuOpen ? 'block' : 'hidden'} id='extended-menu'>
